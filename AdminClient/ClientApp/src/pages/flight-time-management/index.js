...
import FlightDirectionList from "../../components/flight-time/flight-direction-list";
import { Input } from "semantic-ui-react";
import { connect } from "react-redux";

class FlightTimeManagement extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            searchText: ''
...
export default connect(mapStateToProps)(FlightTimeManagement);